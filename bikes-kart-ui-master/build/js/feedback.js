...
window.Feedback = function( options ) {
    ...
    options.url = options.url || "https://localhost:7271/api/Feedback";
...
var RatingMenu = function() {
    var container = document.createElement("div");

    var b = document.createElement("b");
    b.innerText = "How would you rate this page?";
    ...
    option1.innerText = "1 - Poor";
    select.appendChild(option1);

    var option2 = document.createElement("option");
    option2.setAttribute("value", "2");
    option2.innerText = "2 - Below Average";
    select.appendChild(option2);

    var option3 = document.createElement("option");
    option3.setAttribute("value", "3");
    option3.innerText = "3 - Okay";
...
var CategoryMenu = function() {
    ...
    var b = document.createElement("b");
    b.innerText = "Please select feedback category?";
    document.body.appendChild(b);
    ...
    var option1 = document.createElement("option");
    option1.setAttribute("value", "1");
    option1.innerText = "Performance";
    select.appendChild(option1);

    var option2 = document.createElement("option");
    option2.setAttribute("value", "2");
    option2.innerText = "UI";
    select.appendChild(option2);
    ...
    var option4 = document.createElement("option");
    option4.setAttribute("value", "4");
    option4.innerText = "Improvement";
    select.appendChild(option4);

    var option5 = document.createElement("option");
    option5.setAttribute("value", "5");
    option5.innerText = "New Feature";
    select.appendChild(option5);

    var option6 = document.createElement("option");
    option6.setAttribute("value", "6");
    option6.innerText = "Security";
...
var CategoryId = function getOption() {
    selectElement = document.querySelector("#select2");
    output = selectElement.value;
    return output;
};

var Rating = function getOption() {
    ...
    for (; i < len; i++) {
        ...
        switch( item.type ) {
            case "textarea":
                ...
                this.dom.appendChild(CategoryMenu());
				this.dom.appendChild(RatingMenu());
                this.dom.appendChild( element("label", item.label + ":" + (( item.required === true ) ? " *" : "")) );
                this.dom.appendChild( ( item.element = textAreaElement) );
...
window.Feedback.XHR.prototype.send = function( data, callback ) {
    ...
    var pageName = pageUrl.substring(1, 2).toUpperCase() + pageUrl.substring(2);

    var feedbackData = {
        "userId": JSON.parse(userData).id,
        "pageUrl": pageUrl,
        "pageName": pageName,
        "feedbackMessage": data[0].Issue,
        "rating": document.querySelector("#select1").value,
        "categoryId": document.querySelector("#select1").value,
    ...
    xhr.send( window.JSON.stringify( feedbackData ) );
