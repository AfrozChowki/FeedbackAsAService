...
import FeedbackDashboard from "./components/feedback-dashboard.component";
      ...
      <Router history={history}>
          ...
          {currentUser ? (
              <div className="navbar-nav ml-auto">
                <li className="nav-item">
                  <Link to={"/feedbackDashboard"} className="nav-link">
        ...
        <div className="container mt-5">
          <Switch>
            ...
            <Route exact path="/feedbackDashboard" component={FeedbackDashboard}/>
          </Switch>
        </div>
      </Router>
    );
